...
/// Starts an AI call without adding a new user message.
/// Used after resume from Aborted state — queued messages are already in the DB.
pub async fn resume_stream<P: ProjectProvider>(
    manager: &ChatManager<P>,
    chat_id: i64,
    model: &str,
    models: &HashMap<String, ModelConfig>,
